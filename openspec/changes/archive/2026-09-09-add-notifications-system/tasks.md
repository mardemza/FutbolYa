...
- [x] 9.1 Exportar screenshot/HTML de pantalla `99dd47bc88844bc4a7e884815e176d88` a `.stitch-export/` (opcional, gitignored) — omitido a propósito (referencia Stitch online; export local no requerido para cerrar el change)
